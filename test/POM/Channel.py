...
class channel():
    ...
    def play_channel(self):
        ...
        time.sleep(1)
        try:
            # This will play the VoD of channel thru admin user
            self.driver.find_element_by_xpath("// *[ @ id = 'menuContent']/div/ui-view/div/div[3]/vcm-archive-list/div/div[7]/div/div/div[1]/div[2]/span/img").click()
        except Exception as e:
            # This will play the VoD of channel thru normal(test1/test2  etc.) user
            print('Executing another xpath')
