...
class RMXmanagerwithSIPstartrecording:

    def __init__(self,pyautogui):
        print("Rmxmanager SIP login")
        self.pyautogui = pyautogui

    def RMXmanagerSIP(self):
        ...
        self.pyautogui.click()
        time.sleep(3)
        self.pyautogui.moveTo(510, 370)  # selecting SIP
        self.pyautogui.click()
        ...
        time.sleep(3)
        self.pyautogui.click()
        self.pyautogui.press(['backspace', 'backspace', 'backspace', 'backspace', 'backspace', 'backspace'])
        time.sleep(3)
        self.pyautogui.write(parser.get('bug_tracker', 'mssipaddress'))  # Entering the alias name
        # End of additional functionality
        time.sleep(3)
        self.pyautogui.moveTo(525, 585)  # finally selected SIP(OK)
        self.pyautogui.click()
        time.sleep(5)
