...
class Temp(unittest.TestCase):
    ...
    def test_UDP_Registration(self):
        ...
        if checkbox_value == 'true':
            ...
            self.select.select_by_visible_text('UDP')
            time.sleep(3)
        ...
        self.assertEqual(test1_var, 'Online',"EXTMSEN-1606-Assert error: Test case is failed because status is not Online!")
        assert protocol_value == '0', "EXTMSEN-1606-Protocol is not UDP"
        self.driver.quit()
