...
class Tcp(unittest.TestCase):
    ...
    def test_Tcp_Registration(self):
        ...
        if checkbox_value == 'true':
            ...
            self.select.select_by_visible_text('TCP')
            time.sleep(3)
        ...
        self.assertEqual(test1_var, 'Online',"EXTMSEN-1605-Assert error: Test case is failed because status is not Online!")
        assert protocol_value == '1', "EXTMSEN-1606-Protocol is not TCP"
        self.driver.quit()
