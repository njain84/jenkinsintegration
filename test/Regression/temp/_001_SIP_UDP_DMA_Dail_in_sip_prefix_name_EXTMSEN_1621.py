...
import allure
import pytest
from test import test_017_SIP_UDP_DMA_Dail_in_sip_prefix_name_EXTMSEN_1621
...
class Smoke(unittest.TestCase):
    ...
    def test_EXTMSEN_1621(self):
        self.launch_site()


    @allure.step("Launch1 site")
    def launch_site(self):
        Regression = test_017_SIP_UDP_DMA_Dail_in_sip_prefix_name_EXTMSEN_1621.dialindmaformep
        Regression.test_dial_in_dma_MS_form_ep(self)
